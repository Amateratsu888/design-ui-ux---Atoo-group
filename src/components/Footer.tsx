        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm !text-white">
              Votre partenaire de confiance pour l'immobilier haut de gamme au
              Sénégal.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                href="#"
                className="w-10 h-10 bg-neutral-700 hover:bg-primary-700 rounded-lg flex items-center justify-center transition-colors"
              >
        ...
        <div className="border-t border-neutral-700 pt-8 text-sm">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="!text-white">
              &copy; 2024 Atoo Group. Tous droits réservés.
            </p>
            <p className="!text-white">
              Designé et construit avec ❤️ par Nuul Technologies
            </p>
          </div>
          {onNavigate && (
