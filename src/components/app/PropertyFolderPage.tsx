          ...
          <div className="flex">
            {tabs.map((tab) => (
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-3 px-6 py-5 transition-all border-b-4 font-medium ${activeTab === tab.id
          ...
          {activeTab === 'payments' && (
            <div className="space-y-6">
              ...
              <div className="flex justify-end">
                <Button
                  style={{ backgroundColor: '#933096', borderColor: '#933096', color: '#ffffff' }}
                    ...
                    {contract.installments
                      ...
                      .map((installment, index) => {
                        ...
                        return (
                          <div
                            key={installment.id}
                            className={`border-2 rounded-lg p-5 transition-all ${isOverdue
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-4 flex-1">
                                <div className={`w-14 h-14 rounded-lg flex items-center justify-center ${isOverdue
                                  ? 'bg-red-100'
                                  : isUpcoming
                                    ? 'bg-blue-100'
                                    : 'bg-yellow-100'
                                ...
                                <div className="flex-1">
                                  <div className="flex items-center gap-3 mb-2">
                                    ...
                                    <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium ${isOverdue
                      ...
                      <div key={payment.id} className="border border-neutral-200 rounded-lg p-4 bg-white">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="text-right">
                            ...
                            <p className={`text-sm ${payment.status === 'completed'
                              ? 'text-green-600'
                              : payment.status === 'pending'
                                ? 'text-yellow-600'
                                : 'text-red-600'
                  ...
                  <div className="space-y-3">
                    {propertyDocuments.filter(d => d.type === 'contrat').map((doc) => {
                      ...
                      return (
                        <div
                          key={doc.id}
                          className={`border-2 rounded-lg p-5 transition-all ${isSigned
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                              <div className={`w-14 h-14 rounded-lg flex items-center justify-center ${isSigned ? 'bg-green-100' : 'bg-primary-100'
                                }`}>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              >
                                <Eye className="w-4 h-4" style={{ color: '#933096' }} />
                                Lire
                              </Button>
                              {!isSigned && (
                                <Button
                              ...
                              <Button
                                ...
                                style={{ borderColor: '#933096', color: '#933096' }}
                              >
                                <Download className="w-4 h-4" style={{ color: '#933096' }} />
                              </Button>
                            </div>
                          </div>
                        </div>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Button variant="outline" size="sm" style={{ borderColor: '#933096', color: '#933096' }}>
                              <Download className="w-4 h-4" style={{ color: '#933096' }} />
                            </Button>
                          </div>
                        </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center gap-2 p-4 rounded-lg border-2 transition-all ${paymentMethod === 'bank'
                      ? 'border-primary-700 bg-primary-50 text-primary-700'
                      : 'border-neutral-200 bg-white text-neutral-600 hover:border-neutral-300'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center gap-2 p-4 rounded-lg border-2 transition-all ${paymentMethod === 'mobile'
                      ? 'border-primary-700 bg-primary-50 text-primary-700'
                      : 'border-neutral-200 bg-white text-neutral-600 hover:border-neutral-300'
                      }`}
                  >
