  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const propertyData = {
      ...
      bedrooms: newProperty.bedrooms
        ? parseInt(newProperty.bedrooms)
        : undefined,
      bathrooms: newProperty.bathrooms
        ? parseInt(newProperty.bathrooms)
        : undefined,
      images: [
    ...
    console.log(
      "Nouveau bien créé avec exclusivité VIP jusqu'au:",
      vipExpiryDate.toLocaleDateString("fr-FR"),
    );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-600">
            {properties.length} biens au catalogue
          </p>
        </div>
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span
                          className={`px-2 py-0.5 rounded text-sm ${getStatusColor(property.status)}`}
                        >
                          {getStatusLabel(property.status)}
                        </span>
                      </div>
                      <h5 className="text-neutral-900 mb-1">
                        {property.title}
                      </h5>
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6">
              <div className="space-y-6">
                {/* Basic Info */}
                <div>
                  <h4 className="mb-4 text-neutral-900">
                ...
                <div>
                  ...
                  {newProperty.financingOptions.length === 0 && (
                    <p className="text-xs text-red-600 mt-2">
                      Veuillez sélectionner au moins une option de financement
                    </p>
                  )}
                </div>
            ...
            <div className="p-6 space-y-6">
                  ...
                  {(
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        <span
                          className={`text-sm px-2 py-0.5 rounded ${getStatusColor(status)}`}
                        >
              ...
              <div>
                ...
                <div className="space-y-3">
                  {(() => {
                    const isVIPExclusive =
                      selectedProperty.vipOnly &&
                      selectedProperty.vipExclusivityEndDate;
                    const vipEndDate = isVIPExclusive
                      ? new Date(selectedProperty.vipExclusivityEndDate!)
                      : null;
                    const isVIPActive = vipEndDate && vipEndDate > new Date();
                      ...
                      <>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <button
                            onClick={() => {
                              const vipExpiryDate = new Date();
                              vipExpiryDate.setMonth(
                                vipExpiryDate.getMonth() + 1,
                              );
                              console.log(
                                "Activer exclusivité VIP jusqu'au:",
                                vipExpiryDate.toLocaleDateString("fr-FR"),
                              );
                              alert(
                                `Exclusivité VIP activée jusqu'au ${vipExpiryDate.toLocaleDateString("fr-FR")}`,
                              );
                            }}
                ...
                <label className="flex items-center gap-3 p-4 border border-neutral-200 rounded-lg cursor-pointer hover:bg-neutral-50 transition-colors">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      alert(
                        `Mise en vedette: ${e.target.checked ? "Oui" : "Non"}`,
                      );
                    }}
            ...
            <div className="p-6 border-t border-neutral-200 bg-neutral-50">
              <div className="flex gap-3">
                <Button
                  ...
                  onClick={() => {
                    console.log(
                      "Modifications enregistrées pour:",
                      selectedProperty.id,
                    );
