...
export function Navbar({ onNavigate, currentPage, transparentOnTop = false }: NavbarProps) {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3 cursor-pointer" onClick={() => onNavigate('home')}>
              <img src={logo} alt="Atoo Group" className={`h-10 w-auto transition-all duration-300 ${
                ...
                <button
                  ...
                  className={`flex items-center gap-2 transition-colors ${
                    currentPage === item.id 
                      ...
                      : isTransparent ? 'text-white hover:text-white' : 'text-secondary hover:text-primary'
                  }`}
                >
            ...
            <div className="hidden md:flex items-center gap-3">
              <Button 
                ...
                className={isTransparent ? '!bg-primary !text-primary hover:!bg-secondary' : '!bg-primary !text-white hover:!bg-primary'}
              >
      ...
      {/* Mobile Menu */}
      <div className={`md:hidden fixed top-16 left-0 right-0 bottom-0 bg-primary z-50 transform transition-transform duration-300 ${
