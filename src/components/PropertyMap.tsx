...
export function PropertyMap({ coordinates, propertyName, location }: PropertyMapProps) {
  ...
  const initializeMap = () => {
    ...
    const customIcon = L.divIcon({
      html: `<div style="background-color: #933096; width: 32px; height: 32px; border-radius: 50% 50% 50% 0; transform: rotate(-45deg); display: flex; align-items: center; justify-content: center; border: 3px solid white; box-shadow: 0 2px 8px rgba(0,0,0,0.3);"><div style="transform: rotate(45deg); color: white; font-size: 18px;">📍</div></div>`,
